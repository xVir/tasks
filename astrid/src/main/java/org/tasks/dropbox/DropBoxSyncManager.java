...
public class DropBoxSyncManager {
    ...
    @Autowired
    TasksPreferenceManager tasksPreferenceManager;
    ...
    public void resumeLink(Activity activity) {
        if(tasksPreferenceManager.isDropboxSyncEnabled()) {
            initAccountManager(activity);
            startSync();
        }
    }
    ...
    public void clearLink() {
        ...
        tasksPreferenceManager.setDropboxSyncEnabled(false);
    }
    ...
    public void linkSuccessful() {
        ...
        tasksPreferenceManager.setDropboxSyncEnabled(true);
    }
